...
console.log(slice()); //Expected output: [burger, fingerShips, donuts]
//Function #2: Array Splice
function splice() {
    return foods.splice(2, 0, 'noodles', 'icecream');
}
splice();
console.log("Extra Food items=>" + foods); //Expected output: [pizza, burger, noodles, icecream, fingerShips, donuts, springRoll];
//Function #3: Filterconst
...
function isPrime(arr) {
    ...
    return primenumbers;
} // 3.2 Non-Prime Numbersconsole.log(isPrime(numberArray)); // 2 3
...
//Function #6: Mapconst myArray = [11, 34, 20, 5, 53, 16];function findSquareOfNumbers(myArray) {   let squareOfNumber = myArray.map(m => m * m);   return squareOfNumber;}console.log("Squares are=>" + findSquareOfNumbers(myArray));
//Function #7: Reduce
